<script lang="ts">
	...
	let text = $state(
		"Image preview must show up in box. If it doesn't, article won't work. Path can only contain lowercase letters and numbers and hyphens. Spaces are not allowed. Path and image cannot be changed later. Everthing else can (title and contents). No including names of people that are not globally known or places near where you live."
	);
